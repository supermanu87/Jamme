...
public class Signup extends Activity implements OnClickListener{
    ...
    //testing on Emulator:
    private static final String REGISTER_URL = "http://192.168.1.3:8080/register.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegister = (Button)findViewById(R.id.buttonCreateAccount);
